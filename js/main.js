...
salida.innerHTML = `La ganancia total de la tienda es de: ${tienda.GananciaTotal()}$
<br> El código del artículo con mayor precio de venta es: ${tienda.codigoMayorVenta}`